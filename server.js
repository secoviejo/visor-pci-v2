...
bacnetService.on('deviceFound', (device) => {
    ...
    // This section will be moved and wrapped in an ENABLE_HARDWARE check
    ...
    if (ENABLE_HARDWARE) {
        ...
        console.log('[Hardware] Skipping Modbus and BACnet initialization (ENABLE_HARDWARE is not "true")');
    }
